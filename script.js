...
select.addEventListener('change', () => {
  ...
  // Mostrar error fetching temporal
...
refreshBtn.addEventListener('click', () => {
  ...
  // Mostrar error real al refrescar
  errorMsg.innerHTML = '❌ Error al obtener el repositorio';
...
async function fetchRepository(language) {
  try {
    // Solo simula error si no viene de refresh (opcional)
